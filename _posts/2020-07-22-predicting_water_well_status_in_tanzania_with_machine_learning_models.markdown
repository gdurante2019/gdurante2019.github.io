...
For this blog, I want to describe a function I developed to help tackle the challenge of selecting feature values in a way that reduces noise in the modeling and computing resource intensity—specifically, selecting subsets of feature values to convert to dummy variables for modeling.  But first, a bit of background on the competition and the size and scope of this dataset.
