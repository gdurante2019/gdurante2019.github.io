...
## Overview
For my Flatiron School Data Science Boot Camp Module 3 (supervised machine learning) project, I selected a dataset containing data on almost 60,000 water supply projects (‘wells’) in Tanzania.  This was a categorical classification problem with 3 imbalanced target classes and a total of 39 features, most of which are categorical, and several of whic are colinear.  I used data visualization fairly extensively during the exploration phase, and did a deep dive into several supervised machine learning approaches to predict water well status.  Along the way, I developed some useful functions to create visualizations, prepare data for modeling, running models, and displaying results.  
